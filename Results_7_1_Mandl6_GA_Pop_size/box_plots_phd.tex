...
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(1,0.8575)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(2,0.85945)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(4,0.86115)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(5,0.8581)}; 
