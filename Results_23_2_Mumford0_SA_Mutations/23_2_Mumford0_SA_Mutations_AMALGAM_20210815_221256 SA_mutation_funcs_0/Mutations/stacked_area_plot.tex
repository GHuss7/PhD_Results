...
\addplot [draw=blue, fill=blue!30!white] table [mark=none, x=Total_iterations,y=MSC_add_terminal
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
    \addlegendentry{MSC add terminal};

\addplot [draw=red, fill=red!30!white] table [mark=none, x=Total_iterations,y=MSC_del_terminal
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
