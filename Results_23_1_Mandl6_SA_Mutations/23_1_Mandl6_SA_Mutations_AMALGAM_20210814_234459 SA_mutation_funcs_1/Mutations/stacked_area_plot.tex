...
\addplot [draw=blue, fill=blue!30!white] table [mark=none, x=Total_iterations,y=Add_vertex
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
    \addlegendentry{Add vertex};

\addplot [draw=red, fill=red!30!white] table [mark=none, x=Total_iterations,y=Delete_vertex
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
