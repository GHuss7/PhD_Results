...
\addplot [draw=violet, fill=violet!30!white] table [mark=none, x=Total_iterations,y=MSC_add_terminal
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
    \addlegendentry{MSC add terminal};

\addplot [draw=lightgray, fill=lightgray!30!white] table [mark=none, x=Total_iterations,y=MSC_del_terminal
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
    \addlegendentry{MSC del terminal};
