...
\addplot [draw=blue, fill=blue!30!white] table [mark=none, x=Total_iterations,y=Insert_inside_vertex
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
    \addlegendentry{Add inside vertex};

\addplot [draw=red, fill=red!30!white] table [mark=none, x=Total_iterations,y=Delete_inside_vertex
] {Smoothed_Mutation_Ratios_for_Tikz.csv}
    \closedcycle;
