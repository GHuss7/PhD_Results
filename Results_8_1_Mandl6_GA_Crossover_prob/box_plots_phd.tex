...
(1,0.85743)
(1,0.85113)}; 
\addplot[only marks,mark=*,color = blue]coordinates{(1,0.8604)}; 
...
coordinates {
(2,0.84912)}; 
\addplot[only marks,mark=*,color = blue]coordinates{(2,0.85927)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(4,0.85977)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=*,color = blue]coordinates{(5,0.85644)}; 
