...
coordinates {}; 
\addplot[only marks,mark=asterisk,color = blue]coordinates{(1,0.59547)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=asterisk,color = blue]coordinates{(2,0.60406)}; 
...
(4,0.59593)
(4,0.57751)}; 
\addplot[only marks,mark=asterisk,color = blue]coordinates{(4,0.59709)}; 
...
color = blue, solid, area legend] 
coordinates {}; 
\addplot[only marks,mark=asterisk,color = blue]coordinates{(5,0.60308)}; 
